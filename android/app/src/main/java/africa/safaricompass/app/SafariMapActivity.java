...
public class SafariMapActivity extends Activity {
    ...
    private static final Place[] SAFARI_PLACES = {
        ...
        new Place("Etosha", "Namibia", -18.8556, 15.9134), new Place("Kruger", "South Africa", -23.9884, 31.5712),
        new Place("Hwange National Park", "Zimbabwe", -18.7364, 26.9839),
        new Place("South Luangwa National Park", "Zambia", -12.9150, 31.5058),
        new Place("Amboseli National Park", "Kenya", -2.6517, 37.2514),
